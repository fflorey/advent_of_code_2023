...
def find_five_same_cards(cards):
    ...
    for card in cards:
        ...
        if 5 in counts.values() or (4 in counts.values() and 'J' in counts):
            result.append(card)
...
def find_four_same_cards(cards):
    ...
    for card in cards:
        ...
        for char in card:
            counts[char] = counts.get(char, 0) + 1
        if 4 in counts.values() or (3 in counts.values() and 'J' in counts):
            result.append(card)
        elif jokers == 2 and (2 in counts.values()):
            print("Jokers: ", jokers, "in cards ", card, "counts: ", counts)
            # readline = input()
            result.append(card)
        elif jokers == 3:
            result.append(card)
...
def find_full_house(cards):
    ...
    for card in cards:
        ...
        if 3 in counts.values() and (2 in counts.values()):
            result.append(card)
        elif (len(counts) == 3 and list(counts.values()).count(2) == 2) and 'J' in counts:
            result.append(card)        
    return result
...
def find_three_same_cards(cards):
    ...
    for card in cards:
        ...
        for char in card:
            counts[char] = counts.get(char, 0) + 1
        if 3 in counts.values() or (2 in counts.values() and 'J' in counts):
            result.append(card)
        elif jokers == 2:
            result.append(card)
    return result
...
def find_two_pair(cards):
    ...
    for card in cards:
        ...
        if len(counts) == 3 and list(counts.values()).count(2) == 2:
            result.append(card)
        elif len(set(card)) == 4 and 'J' in counts:
            result.append(card)
    return result
...
def find_two_same_cards(cards):
    ...
    for card in cards:
        if len(set(card)) == 4:
            result.append(card)
        elif len(set(card)) == 5 and 'J' in card:
            result.append(card)
    return result
